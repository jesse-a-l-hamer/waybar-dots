...
WEATHER_CODES = {
    **dict.fromkeys(["113"], " "),
    **dict.fromkeys(["116"], " "),
    **dict.fromkeys(["119", "122", "143", "248", "260"], " "),
    **dict.fromkeys(
        [
            "176",
            "179",
    ...
    **dict.fromkeys(["329", "332", "335", "338", "371", "395"], " "),
}
...
if show_location:
    data["text"] += f" - {get_city_name(weather)}"
...
for i in range(FORECAST_DAYS):
    ...
    data["tooltip"] += f" {get_max_temp(day_instance)}  {get_min_temp(day_instance)} "
